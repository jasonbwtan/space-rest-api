	...
	public static void main(String[] args) throws Exception {
		...
		context.addServlet(new ServletHolder(new DefaultServlet() {
			...
			protected void doGet(HttpServletRequest request,
					...
					IOException {
				response.getWriter()
						.append("<html><form method='POST' action='/j_security_check'>"
		...
		loginService.putUser("username", new Password("password"),
				new String[] { "user" });
		securityHandler.setLoginService(loginService);

		FormAuthenticator authenticator = new FormAuthenticator("/login",
				"/login", false);
